...
namespace FinancialBalance
{
    public partial class Main_Form : Form
    {
        ...
        private void MnTaxDeductableInterest_Click(object sender, EventArgs e)
        {
            ...
            Tax_Deductable_Interest_Calculator.Show();
            this.Hide();
        }
        ...
        private void MnETFStocksForecastDivCalendar_Click(object sender, EventArgs e)
        {
            ...
            ETF_Stocks_Forecast_Dividend_Calendar.Show();
            this.Hide();
        }
        ...
        private void MnETFStocksPortfolioSummary_Click(object sender, EventArgs e)
        {
            ...
            ETF_Stocks_Portfolio_Summary.Show();
            this.Hide();
        }
        ...
        private void MnETFStocksFYHistorical_Click(object sender, EventArgs e)
        {
            ETF_Stocks_FY_Historical ETF_Stocks_FY_Historical = new ETF_Stocks_FY_Historical();
            ETF_Stocks_FY_Historical.Show();
            this.Hide();
        }
